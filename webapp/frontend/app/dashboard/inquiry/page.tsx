...
const COLS: Col[] = [
  ...
  { key: "qty",               label: "Qty",                width: 55,  type: "number" },
  { key: "centre_tap",        label: "Centre Tap",         width: 90,  type: "yn"     },
  { key: "submission_date",   label: "Submission Date",    width: 110, type: "date"   },
  { key: "submitted_to",      label: "Submitted To",       width: 160, type: "text"   },
  { key: "price",             label: "Price (₹)",          width: 120, type: "number" },
  { key: "per_rack_price",    label: "Per Rack (₹)",       width: 110, type: "number" },
